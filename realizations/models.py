...
class Ralization(AddAndCreate):
    ...
    used_wood = models.ForeignKey(Product, on_delete=models.DO_NOTHING, verbose_name='Użyte drewno', related_name='used_wood', limit_choices_to={'category_name__product_type': 1},)
    used_products1 = models.ForeignKey(Product, on_delete=models.DO_NOTHING, verbose_name='Użyte produkty (1)', related_name='used_products1', limit_choices_to={'category_name__product_type': 2 or 3}, null=True, blank=True)
    used_products2 = models.ForeignKey(Product, on_delete=models.DO_NOTHING, verbose_name='Użyte produkty (2)', related_name='used_products2', limit_choices_to={'category_name__product_type': 2 or 3}, null=True, blank=True)
